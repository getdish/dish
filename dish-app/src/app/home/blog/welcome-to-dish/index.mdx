...
<IntroText>It has a beautiful origin story.</IntroText>

I assure, but what about _everything else in the universe_. I want to write about many things, but mostly that I want to just store a few ideas I've been playing with in a document.

### The fight is the good

Why do communities fail? Growth, spam, trolls, initial audience, Eternal September, you name it. Everyone survives in spite of entropy, decay, and disorder.

So I just like reminding myself that good things are worth fighting for, but you can't ever stop fighting for them. The fight is the good.
...
Ok, so Google really does look evil. Steadily increasing ad cost, steadily decreasing ad pay, steadily increasing ads, steadily increasing inlining information, steady picking off of competitors, and despite all this, a declining quality of index in many areas (how often does a site filter like "site:reddit.com" _significantly improve_ your results), Ad-blocking-prevention-proposals to baking tracking into Chrome, from the ever-expanding inlining of content to AMP, to their ever-slimming profit-sharing with content creators, moving what was once valuable open source software into Google Play Services, AMP walled gardening, Chrome tracking, YouTube sign in shenanigans (and ads that "jump" down over the first result, though only for those with slower internet connections (discrimination?))... Ad-blocking-prevention-proposals, internet protocols with tracking built in, and more.

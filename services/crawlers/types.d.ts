declare module "@dish/crawlers" {
    ...
    export class Puppeteer {
        ...
        stopInterceptingRequests(): Promise<void>;
        _logBlockCounts(): void;
        private _interceptRequests;
...
declare module "@dish/crawlers" {
    ...
    export class Tripadvisor extends WorkerJob {
        ...
        saveReviews(scrape_id: string, pageNum: number, pup: Puppeteer): Promise<void>;
        savePhotos(scrape_id: string): Promise<void>;

...
declare module "utils" {
    ...
    export function shiftLatLonByMetres(lat: number, lon: number, diff_north: number, diff_east: number): [number, number];
...
declare module "doordash/DoorDash" {
    import '@dish/common';
    import { WorkerJob } from '@dish/worker';
    import { JobOptions, QueueOptions } from 'bull';
    import { ScrapeData } from "scrape-helpers";
    type BasicStore = {
        id: string;
        lat: number;
        lng: number;
...
declare module "grubhub/GrubHub" {
    import '@dish/common';
    import { WorkerJob } from '@dish/worker';
    import { JobOptions, QueueOptions } from 'bull';
    import { ScrapeData } from "scrape-helpers";
...
declare module "infatuated/Infatuated" {
    import '@dish/common';
    import { WorkerJob } from '@dish/worker';
    import { JobOptions, QueueOptions } from 'bull';
    import { ScrapeData } from "scrape-helpers";
    export class Infatuated extends WorkerJob {
        ...
        constructor();
        allForCity(city_name: string): Promise<void>;
        getRestaurants(center: [number, number], start?: number): Promise<void>;
...
declare module "michelin/Michelin" {
    import '@dish/common';
    import { WorkerJob } from '@dish/worker';
    import { JobOptions, QueueOptions } from 'bull';
    import { ScrapeData } from "scrape-helpers";
...
declare module "tripadvisor/Tripadvisor" {
    import '@dish/common';
    import { WorkerJob } from '@dish/worker';
    import { JobOptions, QueueOptions } from 'bull';
    import { ScrapeData } from "scrape-helpers";
    ...
    export function tripadvisorGetFBC(): Promise<import("types").WithID<import("types").Restaurant>>;
}
declare module "ubereats/categories" {
    const _default: {
        JSON: {
            status: string;
            data: {
...
declare module "ubereats/UberEats" {
    import '@dish/common';
    import { WorkerJob } from '@dish/worker';
...
declare module "yelp/Yelp" {
    ...
    export class Yelp extends WorkerJob {
        ...
        static job_config: JobOptions;
        allForCity(city_name: string): Promise<void>;
        getRestaurants(top_right: readonly [number, number], bottom_left: readonly [number, number], start?: number, onlyName?: string): Promise<void>;
...
declare module "canonical-restaurant" {
...
declare module "photo-helpers" {
    import '@dish/common';
    import { PhotoXref, uuid } from '@dish/graph';
    export const photoXrefUpsert: (items: Partial<PhotoXref>[], constraint?: string | undefined, opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<import("types").WithID<PhotoXref>[]>;
    ...
    export function findHeroImage(restaurant_id: uuid): Promise<import("types").WithID<PhotoXref> | null>;
    export function uploadHeroImage(url: string, restaurant_id: uuid): Promise<string | undefined>;
}
declare module "self/gpt3_prompts_text" {
...
declare module "self/remove_404_images" {
    import { Self } from "self/Self";
...
declare module "self/RestaurantBaseScore" {
    import { Self } from "self/Self";
...
declare module "self/RestaurantRatings" {
    import { Self } from "self/Self";
...
declare module "self/RestaurantTagScores" {
    ...
    export class RestaurantTagScores {
        ...
        fetchBertBatch(review_tag_sentences: ReviewTagSentence[]): Promise<ReviewTagSentence[]>;
        ...
        fetchBertSentimentWithRetries(text: string): Promise<any>;
...
declare module "self/update_all_geocoder_ids" {
    import { Restaurant } from '@dish/graph';
    import { Self } from "self/Self";
...
declare module "self/Self" {
    import '@dish/common';
    import { MenuItem, RestaurantWithId } from '@dish/graph';
    import { WorkerJob } from '@dish/worker';
    import { JobOptions, QueueOptions } from 'bull';
    import { Scrape, ScrapeData } from "scrape-helpers";
    import { DB } from "utils";
    import { GPT3 } from "self/GPT3";
    import { RestaurantBaseScore } from "self/RestaurantBaseScore";
    import { RestaurantRatings } from "self/RestaurantRatings";
    import { RestaurantTagScores } from "self/RestaurantTagScores";
    import { Tagging } from "self/Tagging";
...
declare module "google/GooglePuppeteerJob" {
    import '@dish/common';
    import { WorkerJob } from '@dish/worker';
...
declare module "google/GooglePuppeteer" {
    import '@dish/common';
    import { Restaurant } from '@dish/graph';
    import { JobOptions, QueueOptions } from 'bull';
    import { GooglePuppeteerJob } from "google/GooglePuppeteerJob";
...
declare module "google/GoogleReviewAPI" {
    import '@dish/common';
    import { Restaurant } from '@dish/graph';
    import { WorkerJob } from '@dish/worker';
    import { JobOptions, QueueOptions } from 'bull';
...
declare module "google_images/GoogleImages" {
    import '@dish/common';
...
declare module "ci/run" { }
declare module "doordash/all" { }
declare module "doordash/sandbox" { }
declare module "google/UpdateSearchEndpoint" {
    import { JobOptions, QueueOptions } from 'bull';
    import { GooglePuppeteerJob } from "google/GooglePuppeteerJob";
...
declare module "google/all" { }
declare module "google/sandbox" { }
declare module "google/update_search_endpoint" {
    import '@dish/helpers/polyfill';
}
declare module "google_images/all" { }
declare module "google_images/sandbox" { }
declare module "grubhub/all" { }
declare module "infatuated/all" { }
declare module "michelin/all" { }
declare module "self/all" { }
declare module "self/sandbox" {
    import '@dish/helpers/polyfill';
}
declare module "tripadvisor/all" { }
declare module "tripadvisor/sandbox" { }
declare module "ubereats/all" { }
declare module "ubereats/world" { }
declare module "wikipedia/DishTag" {
    type Section = {
        title: string;
        points: string[];
    };
...
declare module "wikipedia/ParseFiverr" {
...
declare module "wikipedia/sandbox" { }
declare module "yelp/all" { }
declare module "yelp/sandbox" {
    import '@dish/helpers/polyfill';
}

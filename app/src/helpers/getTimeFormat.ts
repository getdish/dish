...
// via  https://github.com/vutran/twas/blob/master/index.js

const is = (interval, cycle) => (cycle >= interval ? Math.floor(cycle / interval) : 0)

function relativeTime(time: number, now: number = Date.now()) {

...
import { Button, Dialog, Unspaced, withStaticProperties } from 'tamagui';
export const DishDialog = withStaticProperties(Dialog, {
    Content: ({ closable, children, ...props }) => (<Dialog.Portal>
      ...
      <Dialog.Content bordered elevate key="content" space animation={[
        ...
        ]} enterStyle={{ x: 0, y: -20, opacity: 0, scale: 0.9 }} exitStyle={{ x: 0, y: 10, opacity: 0, scale: 0.95 }} x={0} scale={1} opacity={1} y={0} {...props}>
        {children}

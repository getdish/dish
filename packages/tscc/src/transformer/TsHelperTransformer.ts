...
import {
  createGoogCall,
  findGoogRequiredVariable,
  findImportedVariable,
  identifierIsEmitHelper,
...
export default abstract class TsHelperTransformer {
   ...
   */
  protected abstract onHelperCall(
  ...
  transformSourceFile(): ts.SourceFile {
    ...
    return ts.updateSourceFileNode(
      newSf,
      ts.setTextRange(ts.createNodeArray(stmts), newSf.statements)
    )
  }

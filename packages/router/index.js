...
const history = process.env.TARGET === 'node' ||
...
export class Router extends Store {
    ...
    mount() {
        ...
        history.listen((event) => {
            ...
            const direction = (prevItem === null || prevItem === void 0 ? void 0 : prevItem.id) === id
                ? 'backward'
                : (nextItem === null || nextItem === void 0 ? void 0 : nextItem.id) === id
                    ? 'forward'
                    : 'none';
            let type = event.action === 'REPLACE'
                ? 'replace'
                : event.action === 'POP'
                    ? 'pop'
                    : 'push';
    ...
    handlePath(pathname, item) {
        ...
        const next = {
            id: (_a = item.id) !== null && _a !== void 0 ? _a : uid(),
            type: item.type,
            ...
            search: (_c = (_b = window.location) === null || _b === void 0 ? void 0 : _b.search) !== null && _c !== void 0 ? _c : '',
        };

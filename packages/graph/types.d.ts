declare module "@dish/graph" {
    export const isManualDebugMode: boolean;
    ...
    export const TILES_HOST: string;
    export const TILES_HOST_INTERNAL: string;
...
declare module "@dish/graph" {
    ...
    export interface restaurant_bool_exp {
        ...
        name?: Maybe<String_comparison_exp>;
        og_source_ids?: Maybe<jsonb_comparison_exp>;
    ...
    export const generatedSchema: {
        ...
        readonly mutation: {
            ...
            readonly update_photo: {
                readonly __type: "photo_mutation_response";
                readonly __args: {
                    readonly _append: "photo_append_input";
                    readonly _delete_at_path: "photo_delete_at_path_input";
                    readonly _delete_elem: "photo_delete_elem_input";
                    readonly _delete_key: "photo_delete_key_input";
                    readonly _inc: "photo_inc_input";
                    readonly _prepend: "photo_prepend_input";
        ...
        readonly list: {
            ...
            readonly list_reviews_aggregate: {
                readonly __type: "review_aggregate!";
                readonly __args: {
                    readonly distinct_on: "[review_select_column!]";
                    readonly limit: "Int";
        ...
        readonly photo_delete_at_path_input: {
            readonly categories: {
                readonly __type: "[String]";
            };
        };
        readonly photo_delete_elem_input: {
            readonly categories: {
                readonly __type: "Int";
            };
        };
        readonly photo_delete_key_input: {
            readonly categories: {
                readonly __type: "String";
            };
        };
    ...
    export type SchemaObjectTypesNames = 'Query' | 'Mutation' | 'Subscription' | 'hrr' | 'hrr_aggregate' | 'hrr_aggregate_fields' | 'hrr_avg_fields' | 'hrr_max_fields' | 'hrr_min_fields' | 'hrr_mutation_response' | 'hrr_stddev_fields' | 'hrr_stddev_pop_fields' | 'hrr_stddev_samp_fields' | 'hrr_sum_fields' | 'hrr_var_pop_fields' | 'hrr_var_samp_fields' | 'hrr_variance_fields' | 'list' | 'list_aggregate' | 'list_aggregate_fields' | 'list_avg_fields' | 'list_max_fields' | 'list_min_fields' | 'list_mutation_response' | 'list_restaurant' | 'list_restaurant_aggregate' | 'list_restaurant_aggregate_fields' | 'list_restaurant_avg_fields' | 'list_restaurant_max_fields' | 'list_restaurant_min_fields' | 'list_restaurant_mutation_response' | 'list_restaurant_stddev_fields' | 'list_restaurant_stddev_pop_fields' | 'list_restaurant_stddev_samp_fields' | 'list_restaurant_sum_fields' | 'list_restaurant_tag' | 'list_restaurant_tag_aggregate' | 'list_restaurant_tag_aggregate_fields' | 'list_restaurant_tag_avg_fields' | 'list_restaurant_tag_max_fields' | 'list_restaurant_tag_min_fields' | 'list_restaurant_tag_mutation_response' | 'list_restaurant_tag_stddev_fields' | 'list_restaurant_tag_stddev_pop_fields' | 'list_restaurant_tag_stddev_samp_fields' | 'list_restaurant_tag_sum_fields' | 'list_restaurant_tag_var_pop_fields' | 'list_restaurant_tag_var_samp_fields' | 'list_restaurant_tag_variance_fields' | 'list_restaurant_var_pop_fields' | 'list_restaurant_var_samp_fields' | 'list_restaurant_variance_fields' | 'list_stddev_fields' | 'list_stddev_pop_fields' | 'list_stddev_samp_fields' | 'list_sum_fields' | 'list_tag' | 'list_tag_aggregate' | 'list_tag_aggregate_fields' | 'list_tag_max_fields' | 'list_tag_min_fields' | 'list_tag_mutation_response' | 'list_var_pop_fields' | 'list_var_samp_fields' | 'list_variance_fields' | 'menu_item' | 'menu_item_aggregate' | 'menu_item_aggregate_fields' | 'menu_item_avg_fields' | 'menu_item_max_fields' | 'menu_item_min_fields' | 'menu_item_mutation_response' | 'menu_item_stddev_fields' | 'menu_item_stddev_pop_fields' | 'menu_item_stddev_samp_fields' | 'menu_item_sum_fields' | 'menu_item_var_pop_fields' | 'menu_item_var_samp_fields' | 'menu_item_variance_fields' | 'nhood_labels' | 'nhood_labels_aggregate' | 'nhood_labels_aggregate_fields' | 'nhood_labels_avg_fields' | 'nhood_labels_max_fields' | 'nhood_labels_min_fields' | 'nhood_labels_mutation_response' | 'nhood_labels_stddev_fields' | 'nhood_labels_stddev_pop_fields' | 'nhood_labels_stddev_samp_fields' | 'nhood_labels_sum_fields' | 'nhood_labels_var_pop_fields' | 'nhood_labels_var_samp_fields' | 'nhood_labels_variance_fields' | 'opening_hours' | 'opening_hours_aggregate' | 'opening_hours_aggregate_fields' | 'opening_hours_max_fields' | 'opening_hours_min_fields' | 'opening_hours_mutation_response' | 'photo' | 'photo_aggregate' | 'photo_aggregate_fields' | 'photo_avg_fields' | 'photo_max_fields' | 'photo_min_fields' | 'photo_mutation_response' | 'photo_stddev_fields' | 'photo_stddev_pop_fields' | 'photo_stddev_samp_fields' | 'photo_sum_fields' | 'photo_var_pop_fields' | 'photo_var_samp_fields' | 'photo_variance_fields' | 'photo_xref' | 'photo_xref_aggregate' | 'photo_xref_aggregate_fields' | 'photo_xref_max_fields' | 'photo_xref_min_fields' | 'photo_xref_mutation_response' | 'restaurant' | 'restaurant_aggregate' | 'restaurant_aggregate_fields' | 'restaurant_avg_fields' | 'restaurant_max_fields' | 'restaurant_min_fields' | 'restaurant_mutation_response' | 'restaurant_stddev_fields' | 'restaurant_stddev_pop_fields' | 'restaurant_stddev_samp_fields' | 'restaurant_sum_fields' | 'restaurant_tag' | 'restaurant_tag_aggregate' | 'restaurant_tag_aggregate_fields' | 'restaurant_tag_avg_fields' | 'restaurant_tag_max_fields' | 'restaurant_tag_min_fields' | 'restaurant_tag_mutation_response' | 'restaurant_tag_stddev_fields' | 'restaurant_tag_stddev_pop_fields' | 'restaurant_tag_stddev_samp_fields' | 'restaurant_tag_sum_fields' | 'restaurant_tag_var_pop_fields' | 'restaurant_tag_var_samp_fields' | 'restaurant_tag_variance_fields' | 'restaurant_var_pop_fields' | 'restaurant_var_samp_fields' | 'restaurant_variance_fields' | 'review' | 'review_aggregate' | 'review_aggregate_fields' | 'review_avg_fields' | 'review_max_fields' | 'review_min_fields' | 'review_mutation_response' | 'review_stddev_fields' | 'review_stddev_pop_fields' | 'review_stddev_samp_fields' | 'review_sum_fields' | 'review_tag_sentence' | 'review_tag_sentence_aggregate' | 'review_tag_sentence_aggregate_fields' | 'review_tag_sentence_avg_fields' | 'review_tag_sentence_max_fields' | 'review_tag_sentence_min_fields' | 'review_tag_sentence_mutation_response' | 'review_tag_sentence_stddev_fields' | 'review_tag_sentence_stddev_pop_fields' | 'review_tag_sentence_stddev_samp_fields' | 'review_tag_sentence_sum_fields' | 'review_tag_sentence_var_pop_fields' | 'review_tag_sentence_var_samp_fields' | 'review_tag_sentence_variance_fields' | 'review_var_pop_fields' | 'review_var_samp_fields' | 'review_variance_fields' | 'setting' | 'setting_aggregate' | 'setting_aggregate_fields' | 'setting_max_fields' | 'setting_min_fields' | 'setting_mutation_response' | 'tag' | 'tag_aggregate' | 'tag_aggregate_fields' | 'tag_avg_fields' | 'tag_max_fields' | 'tag_min_fields' | 'tag_mutation_response' | 'tag_stddev_fields' | 'tag_stddev_pop_fields' | 'tag_stddev_samp_fields' | 'tag_sum_fields' | 'tag_tag' | 'tag_tag_aggregate' | 'tag_tag_aggregate_fields' | 'tag_tag_max_fields' | 'tag_tag_min_fields' | 'tag_tag_mutation_response' | 'tag_var_pop_fields' | 'tag_var_samp_fields' | 'tag_variance_fields' | 'user' | 'user_aggregate' | 'user_aggregate_fields' | 'user_avg_fields' | 'user_max_fields' | 'user_min_fields' | 'user_mutation_response' | 'user_stddev_fields' | 'user_stddev_pop_fields' | 'user_stddev_samp_fields' | 'user_sum_fields' | 'user_var_pop_fields' | 'user_var_samp_fields' | 'user_variance_fields' | 'zcta5' | 'zcta5_aggregate' | 'zcta5_aggregate_fields' | 'zcta5_avg_fields' | 'zcta5_max_fields' | 'zcta5_min_fields' | 'zcta5_mutation_response' | 'zcta5_stddev_fields' | 'zcta5_stddev_pop_fields' | 'zcta5_stddev_samp_fields' | 'zcta5_sum_fields' | 'zcta5_var_pop_fields' | 'zcta5_var_samp_fields' | 'zcta5_variance_fields';
...
declare module "@dish/graph" {
    ...
    export const client: import("gqless").GqlessClient<GeneratedSchema>;
    export const query: import("graphql/schema.generated").Query, mutation: import("graphql/schema.generated").Mutation, subscription: import("graphql/schema.generated").Subscription, resolved: import("gqless").Resolved, refetch: import("gqless").Refetch, setCache: import("gqless").SetCache, mutate: import("gqless").Mutate<GeneratedSchema>;
}

declare module "@dish/graph" {
    export const graphql: import("@gqless/react").GraphQLHOC, useQuery: import("@gqless/react").UseQuery<GeneratedSchema>, useMutation: import("@gqless/react").UseMutation<GeneratedSchema>, useLazyQuery: import("@gqless/react").UseLazyQuery<GeneratedSchema>, prepareQuery: import("@gqless/react").PrepareQuery<GeneratedSchema>, useMetaState: import("@gqless/react").UseMetaState, useSubscription: import("@gqless/react").UseSubscription<GeneratedSchema>, useTransactionQuery: import("@gqless/react").UseTransactionQuery<GeneratedSchema>, useRefetch: import("@gqless/react").UseRefetch, prepareReactRender: import("@gqless/react").PrepareReactRender, useHydrateCache: import("@gqless/react").UseHydrateCache, usePaginatedQuery: import("@gqless/react").UsePaginatedQuery<GeneratedSchema>, state: {
        isLoading: boolean;
    };
}
...
declare module "@dish/graph" {
    export const tagTagInsert: (items: Partial<import("types").FlatResolvedModel<import("types").TagTagQuery>>[], opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").TagTagQuery>>[]>;
    export const tagTagUpsert: (items: Partial<import("types").FlatResolvedModel<import("types").TagTagQuery>>[], constraint?: string | undefined, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").TagTagQuery>>[]>;
    export const tagTagUpdate: (a: import("types").WithID<Partial<import("types").FlatResolvedModel<import("types").TagTagQuery>>>, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").WithID<import("types").FlatResolvedModel<import("types").TagTagQuery>>>>;
    export const tagTagFindOne: (a: Partial<import("types").FlatResolvedModel<import("types").TagTagQuery>>, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").TagTagQuery>> | null>;
    export const tagTagRefresh: (a: import("types").WithID<import("types").FlatResolvedModel<import("types").TagTagQuery>>) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").TagTagQuery>>>;
}

declare module "@dish/graph" {
    export const tagInsert: (items: Partial<import("types").FlatResolvedModel<import("types").TagQuery>>[], opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").TagQuery>>[]>;
    export const tagUpsert: (items: Partial<import("types").FlatResolvedModel<import("types").TagQuery>>[], constraint?: string | undefined, opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").TagQuery>>[]>;
    export const tagUpdate: (a: import("types").WithID<Partial<import("types").FlatResolvedModel<import("types").TagQuery>>>, opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").WithID<import("types").FlatResolvedModel<import("types").TagQuery>>>>;
    export const tagFindOne: (a: Partial<import("types").FlatResolvedModel<import("types").TagQuery>>, opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").TagQuery>> | null>;
    export const tagFindAll: (a: Partial<import("types").FlatResolvedModel<import("types").TagQuery>>, opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").TagQuery>>[]>;
    export const tagDelete: (a: import("types").WithID<Partial<import("types").FlatResolvedModel<import("types").TagQuery>>>) => Promise<void>;
    export const tagRefresh: (a: import("types").WithID<import("types").FlatResolvedModel<import("types").TagQuery>>) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").TagQuery>>>;
    export const tagFindOneWithCategories: (tag: Partial<Tag>) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").TagQuery>> | null>;
    export const tagSelectAll: {
        select: (vTags: tag[]) => {
            alternates: any;
            __typename: "tag" | undefined;
            categories: (args?: {
                distinct_on?: (import("graphql").tag_tag_select_column | undefined)[] | undefined;
                limit?: number | undefined;
                offset?: number | undefined;
                order_by?: import("graphql").Maybe<import("graphql").tag_tag_order_by[]> | undefined;
                where?: import("graphql").Maybe<import("graphql").tag_tag_bool_exp> | undefined;
            } | undefined) => import("graphql").tag_tag[];
            categories_aggregate: (args?: {
                distinct_on?: (import("graphql").tag_tag_select_column | undefined)[] | undefined;
                limit?: number | undefined;
                offset?: number | undefined;
                order_by?: import("graphql").Maybe<import("graphql").tag_tag_order_by[]> | undefined;
                where?: import("graphql").Maybe<import("graphql").tag_tag_bool_exp> | undefined;
            } | undefined) => import("graphql").tag_tag_aggregate;
            created_at: any;
            ...
            id: any;
            is_ambiguous: boolean | undefined;
            misc?: any;
            name: string | undefined;
            order: number | undefined;
            parent?: import("graphql").Maybe<tag> | undefined;
            parentId?: any;
            popularity?: number | undefined;
            restaurant_taxonomies: (args?: {
                distinct_on?: (import("graphql").restaurant_tag_select_column | undefined)[] | undefined;
                limit?: number | undefined;
                offset?: number | undefined;
            ...
            } | undefined) => import("graphql").restaurant_tag[];
            restaurant_taxonomies_aggregate: (args?: {
                distinct_on?: (import("graphql").restaurant_tag_select_column | undefined)[] | undefined;
                limit?: number | undefined;
                offset?: number | undefined;
    ...
    export function tagUpsertCategorizations(tag: TagWithId, category_tag_ids: string[]): Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").TagTagQuery>>[]>;
...
declare module "@dish/graph" {
    ...
    export const tagSlugWithAndWithoutParent: (tag: Tag) => (string | undefined)[];
    export const tagSlugs: (tag: Tag) => string[];
    export const tagIsOrphan: (tag: Tag) => boolean;
    export function getTagNameWithIcon(tag: Tag): string | undefined;
}
...
declare module "@dish/graph" {
    export const listInsert: (items: Partial<import("types").FlatResolvedModel<import("types").ListQuery>>[], opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").ListQuery>>[]>;
    export const listUpsert: (items: Partial<import("types").FlatResolvedModel<import("types").ListQuery>>[], constraint?: string | undefined, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").ListQuery>>[]>;
    export const listUpdate: (a: import("types").WithID<Partial<import("types").FlatResolvedModel<import("types").ListQuery>>>, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").WithID<import("types").FlatResolvedModel<import("types").ListQuery>>>>;
    export const listFindOne: (a: Partial<import("types").FlatResolvedModel<import("types").ListQuery>>, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").ListQuery>> | null>;
    export const listRefresh: (a: import("types").WithID<import("types").FlatResolvedModel<import("types").ListQuery>>) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").ListQuery>>>;
}

declare module "@dish/graph" {
    export const menuItemInsert: (items: Partial<import("types").FlatResolvedModel<import("types").MenuItemQuery>>[], opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").MenuItemQuery>>[]>;
    export const menuItemUpsert: (items: Partial<import("types").FlatResolvedModel<import("types").MenuItemQuery>>[], constraint?: string | undefined, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").MenuItemQuery>>[]>;
    export const menuItemUpdate: (a: import("types").WithID<Partial<import("types").FlatResolvedModel<import("types").MenuItemQuery>>>, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").WithID<import("types").FlatResolvedModel<import("types").MenuItemQuery>>>>;
    export const menuItemFindOne: (a: Partial<import("types").FlatResolvedModel<import("types").MenuItemQuery>>, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").MenuItemQuery>> | null>;
    export const menuItemFindAll: (a: Partial<import("types").FlatResolvedModel<import("types").MenuItemQuery>>, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").MenuItemQuery>>[]>;
    export const menuItemRefresh: (a: import("types").WithID<import("types").FlatResolvedModel<import("types").MenuItemQuery>>) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").MenuItemQuery>>>;
...
declare module "@dish/graph" {
    export const restaurantInsert: (items: Partial<import("types").FlatResolvedModel<import("types").RestaurantQuery>>[], opts?: SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").RestaurantQuery>>[]>;
    export const restaurantUpsert: (items: Partial<import("types").FlatResolvedModel<import("types").RestaurantQuery>>[], constraint?: string | undefined, opts?: SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").RestaurantQuery>>[]>;
    export const restaurantUpdate: (a: import("types").WithID<Partial<import("types").FlatResolvedModel<import("types").RestaurantQuery>>>, opts?: SelectionOptions | undefined) => Promise<import("types").WithID<import("types").WithID<import("types").FlatResolvedModel<import("types").RestaurantQuery>>>>;
    export const restaurantFindOne: (a: Partial<import("types").FlatResolvedModel<import("types").RestaurantQuery>>, opts?: SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").RestaurantQuery>> | null>;
    export const restaurantRefresh: (a: import("types").WithID<import("types").FlatResolvedModel<import("types").RestaurantQuery>>) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").RestaurantQuery>>>;
    ...
    export function restaurantFindOneWithTags(restaurant: Partial<RestaurantWithId>): Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").RestaurantQuery>> | null>;
    ...
    export function restaurantUpsertOrphanTags(restaurant: RestaurantWithId, tag_strings: string[]): Promise<import("types").WithID<import("types").WithID<import("types").FlatResolvedModel<import("types").RestaurantQuery>>> | null>;
    export function convertSimpleTagsToRestaurantTags(tag_strings: string[]): Promise<{
        tag_id: any;
    }[]>;
    export function restaurantUpsertRestaurantTags(restaurant: RestaurantWithId, restaurant_tags: Partial<RestaurantTag>[], opts?: SelectionOptions): Promise<import("types").WithID<import("types").WithID<import("types").FlatResolvedModel<import("types").RestaurantQuery>>> | null>;
    export function restaurantGetAllPossibleTags(restaurant: Restaurant): Promise<any[]>;
}

declare module "@dish/graph" {
    export type uuid = Scalars['uuid'];
    export const reviewInsert: (items: Partial<import("types").FlatResolvedModel<import("types").ReviewQuery>>[], opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").ReviewQuery>>[]>;
    export const reviewUpsert: (items: Partial<import("types").FlatResolvedModel<import("types").ReviewQuery>>[], constraint?: string | undefined, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").ReviewQuery>>[]>;
    export const reviewUpdate: (a: import("types").WithID<Partial<import("types").FlatResolvedModel<import("types").ReviewQuery>>>, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").WithID<import("types").FlatResolvedModel<import("types").ReviewQuery>>>>;
    export const reviewFindOne: (a: Partial<import("types").FlatResolvedModel<import("types").ReviewQuery>>, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").ReviewQuery>> | null>;
    export const reviewRefresh: (a: import("types").WithID<import("types").FlatResolvedModel<import("types").ReviewQuery>>) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").ReviewQuery>>>;
    export const reviewDelete: (a: import("types").WithID<Partial<import("types").FlatResolvedModel<import("types").ReviewQuery>>>) => Promise<void>;
}
...
declare module "@dish/graph" {
    export const settingInsert: (items: Partial<import("types").FlatResolvedModel<import("types").SettingQuery>>[], opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<WithID<import("types").FlatResolvedModel<import("types").SettingQuery>>[]>;
    export const settingUpsert: (items: Partial<import("types").FlatResolvedModel<import("types").SettingQuery>>[], constraint?: string | undefined, opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<WithID<import("types").FlatResolvedModel<import("types").SettingQuery>>[]>;
    export const _settingFindOne: (a: Partial<import("types").FlatResolvedModel<import("types").SettingQuery>>, opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<WithID<import("types").FlatResolvedModel<import("types").SettingQuery>> | null>;
...
declare module "@dish/graph" {
    export const userInsert: (items: Partial<import("types").FlatResolvedModel<import("types").UserQuery>>[], opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").UserQuery>>[]>;
    export const userUpsert: (items: Partial<import("types").FlatResolvedModel<import("types").UserQuery>>[], constraint?: string | undefined, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").UserQuery>>[]>;
    export const userUpdate: (a: import("types").WithID<Partial<import("types").FlatResolvedModel<import("types").UserQuery>>>, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").WithID<import("types").FlatResolvedModel<import("types").UserQuery>>>>;
    export const userFindOne: (a: Partial<import("types").FlatResolvedModel<import("types").UserQuery>>, opts?: import("index").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").UserQuery>> | null>;
    export const userRefresh: (a: import("types").WithID<import("types").FlatResolvedModel<import("types").UserQuery>>) => Promise<import("types").WithID<import("types").FlatResolvedModel<import("types").UserQuery>>>;
}

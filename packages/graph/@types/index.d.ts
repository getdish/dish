...
declare module "Auth" {
    ...
    class AuthModel {
        ...
        register(username: string, email: string, password: string): Promise<readonly [number, any]>;
        login(login: string, password: string): Promise<readonly [number, string] | readonly [200 | 201, any]>;
        setLoginData(data: {
            user: any;
            token: string;
        }): void;
...
declare module "generate" {
    import '@dish/helpers/polyfill';
}
declare module "graphql/schema.generated" {
...
declare module "react" {
    import { GeneratedSchema } from "graphql/index";
...
declare module "startLogging" {
    export function startLogging(verbose?: boolean): void;
}
declare module "types" {
    import { list, menu_item, photo, photo_xref, restaurant, restaurant_tag, review, setting, tag, tag_tag, user } from "graphql/index";
    ...
    export type ModelType = Restaurant | Tag | RestaurantTag | TagTag | User | Review | MenuItem | PhotoBase | PhotoXref | Setting | List;
...
declare module "helpers/queryResolvers" {
...
declare module "helpers/isMutatableField" {
...
declare module "helpers/queryHelpers" {
    import { Scalars } from "graphql/index";
    ...
    export function deleteByIDs(table: string, ids: uuid[]): Promise<void>;
...
declare module "helpers/flushTestData" {
    export function flushTestData(): Promise<void>;
}
declare module "helpers/tagHelpers" {
...
declare module "queries/menuItemQueries" {
...
declare module "queries/restaurantTagQueries" {
    import { restaurant_tag } from "graphql/index";
...
declare module "queries/tagTagQueries" {
...
declare module "queries/tagQueries" {
...
declare module "queries/restaurantQueries" {
    import { restaurant } from "graphql/index";
    import { SelectionOptions } from "helpers/queryResolvers";
    ...
    export function restaurantUpsertManyTags(restaurant: RestaurantWithId, restaurant_tags: Partial<RestaurantTag>[], opts?: SelectionOptions): Promise<import("types").WithID<import("types").WithID<Restaurant>> | null>;
...
declare module "queries/reviewQueries" {
    import { Scalars } from "graphql/index";
    import { Review } from "types";
    export type uuid = Scalars['uuid'];
    export const reviewInsert: (items: Partial<Review>[], opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<import("types").WithID<Review>[]>;
    export const reviewUpsert: (items: Partial<Review>[], constraint?: string | undefined, opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<import("types").WithID<Review>[]>;
    export const reviewUpdate: (a: import("types").WithID<Partial<Review>>, opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<import("types").WithID<import("types").WithID<Review>>>;
    export const reviewFindOne: (a: Partial<Review>, opts?: import("helpers/queryResolvers").SelectionOptions | undefined) => Promise<import("types").WithID<Review> | null>;
    ...
    export function reviewFindAllForRestaurant(restaurant_id: uuid, fn?: (v: any) => unknown): Promise<any>;
    export function reviewFindAllForUser(user_id: uuid): Promise<any>;
    export function userFavoriteARestaurant(user_id: uuid, restaurant_id: uuid, favorited?: boolean): Promise<import("types").WithID<Review>>;
    export function userFavorites(user_id: string): Promise<any>;
    export function reviewExternalUpsert(reviews: Review[]): Promise<import("types").WithID<Review>[]>;
...
declare module "queries/searchQueries" {
...
declare module "queries/settingQueries" {
...
declare module "queries/userQueries" {
...
declare module "helpers/allFieldsForTable" {

...
// const selectFields: (o: any,a: string) => any = () => {}

// selectFields(query.menu_item()[0], "a.b.c")

// query.menu_item()[0].restaurant.menu_items()[0].restaurant.city

// const getAllFields = () => {
//   const item = query.menu_item()[0];

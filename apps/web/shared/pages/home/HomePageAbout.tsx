      ...
      >
        <VStack spacing="xl">
          ...
          <VStack spacing="lg">
            ...
            <Paragraph>
              We'd like it to grow to becomes your real world Pokedex.
            </Paragraph>

            <Paragraph>Let us know how you'd love it to look.</Paragraph>

            <Paragraph>Or just vent about all the bugs:</Paragraph>

...
struct CameraView: UIViewControllerRepresentable {
  ...
  func updateUIViewController(
    _ uiViewController: UIViewController, context: UIViewControllerRepresentableContext<CameraView>
  ) {
    context.coordinator.update(self)
  }

  func makeUIViewController(context: UIViewControllerRepresentableContext<CameraView>)
    -> UIViewController
  {
...
extension CameraViewController: AVCapturePhotoCaptureDelegate {
  func photoOutput(
    ...
    guard
      let imageRef = capturedImage.cgImage?.cropping(to: CGRect(origin: imgOrigin, size: imgSize))
    else {
